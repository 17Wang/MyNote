...
public class MenuEditor extends JMenu {
    ...
    //组件
    private JMenuItem _cz=new JMenuItem("     查找");
    private JMenuItem _th=new JMenuItem("     替换");
    private JMenuItem _qx=new JMenuItem("     全选");
    public JDialog jd;
    public JDialog jd0;
    ...
    //监听器
    private ActionListener _menuEditorListner=new ActionListener() {
    ...
    public MenuEditor(String name,Note frame,NoteWriteArea writeArea){
        super(name);
        ...
        _cz.addActionListener(_menuEditorListner);
        _th.addActionListener(_menuEditorListner);
        _qx.addActionListener(_menuEditorListner);
    ...
    private void SelectAll(){
        _parentText.setSelectionStart(0);
    }
}
